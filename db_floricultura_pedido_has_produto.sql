...
--
-- Host: localhost    Database: db_floricultura
-- ------------------------------------------------------
...
CREATE TABLE `pedido_has_produto` (
  ...
  KEY `fk_pedido_has_produto_pedido` (`fk_pedido`),
  KEY `fk_pedido_has_produto_produto` (`fk_produto`),
  CONSTRAINT `fk_pedido_has_produto_pedido` FOREIGN KEY (`fk_pedido`) REFERENCES `pedido` (`idPedido`),
  CONSTRAINT `fk_pedido_has_produto_produto` FOREIGN KEY (`fk_produto`) REFERENCES `produto` (`idProduto`)
